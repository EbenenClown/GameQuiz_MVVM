...
class CreateLocalUserUseCase @Inject constructor(private val userRepository: UserRepository, private val dataStoreRepository: DataStoreRepository) {
    ...
    suspend operator fun invoke(userDomainModel: UserDomainModel = UserDomainModel(UUID.randomUUID().toString(), "", "", false)) {
        ...
        dataStoreRepository.saveUserId(userDomainModel.userId)
    }
}